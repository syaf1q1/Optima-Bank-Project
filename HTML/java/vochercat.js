...
window.VoucherPDFGenerator = {
  generatePDF: function(voucherData) {
    try {
      ...
      // Add voucher image where QR code was
      const img = new Image();
      ...
      img.onload = () => {
        ...
        // QR Code section at bottom (before footer)
        doc.setDrawColor(...lightGray);
      ...
      img.onerror = () => {
        ...
        console.warn('Image failed to load, generating PDF without image');
        this.generatePDFWithoutImage(doc, voucherData, primaryColor, textColor, lightGray);
      };
